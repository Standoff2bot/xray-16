    ...
    bool DO_NOT_FINISH)
{
    ...
    if (C.bDetail_Bump)
    {
        LPCSTR detail_bump_texture = TextureDescr.GetBumpName(dt).c_str();
...
// Uber-construct
    ...
    // C.r_Sampler("s_base", C.L_textures[0], false, nvrhi::SamplerAddressMode::Wrap,
    // SamplerFilter::Anisotropic,SamplerFilter::Linear,
    // SamplerFilter::Anisotropic);
    // C.r_Sampler("s_bumpX", fnameB, false, nvrhi::SamplerAddressMode::Wrap,
    // SamplerFilter::Anisotropic,SamplerFilter::Linear,
    // SamplerFilter::Anisotropic); // should be before base bump
    // C.r_Sampler("s_bump", fnameA, false, nvrhi::SamplerAddressMode::Wrap,
    // SamplerFilter::Anisotropic,SamplerFilter::Linear,
    // SamplerFilter::Anisotropic);
    // C.r_Sampler("s_bumpD", dt, false, nvrhi::SamplerAddressMode::Wrap,
    // SamplerFilter::Anisotropic,SamplerFilter::Linear,
    // SamplerFilter::Anisotropic);
    // C.r_Sampler("s_detail", dt, false, nvrhi::SamplerAddressMode::Wrap,
    // SamplerFilter::Anisotropic, SamplerFilter::Linear,
    // SamplerFilter::Anisotropic);
    ...
    if (lmap)
    {
        // C.r_Sampler("s_hemi", C.L_textures[2], false, nvrhi::SamplerAddressMode::Clamp, SamplerFilter::Linear, SamplerFilter::Point,
    ...
    C.r_Sampler(
        "s_base", C.L_textures[0], false, nvrhi::SamplerAddressMode::Wrap, SamplerFilter::Anisotropic, SamplerFilter::Linear, SamplerFilter::Anisotropic);
    C.r_Sampler("s_bumpX", fnameB, false, nvrhi::SamplerAddressMode::Wrap, SamplerFilter::Anisotropic, SamplerFilter::Linear,
        SamplerFilter::Anisotropic); // should be before base bump
    C.r_Sampler("s_bump", fnameA, false, nvrhi::SamplerAddressMode::Wrap, SamplerFilter::Anisotropic, SamplerFilter::Linear, SamplerFilter::Anisotropic);
    C.r_Sampler("s_bumpD", dt, false, nvrhi::SamplerAddressMode::Wrap, SamplerFilter::Anisotropic, SamplerFilter::Linear, SamplerFilter::Anisotropic);
    C.r_Sampler("s_detail", dt, false, nvrhi::SamplerAddressMode::Wrap, SamplerFilter::Anisotropic, SamplerFilter::Linear, SamplerFilter::Anisotropic);
    if (bHasDetailBump)
    {
        C.r_Sampler("s_detailBump", texDetailBump, false, nvrhi::SamplerAddressMode::Wrap, SamplerFilter::Anisotropic, SamplerFilter::Linear,
            SamplerFilter::Anisotropic);
        C.r_Sampler("s_detailBumpX", texDetailBumpX, false, nvrhi::SamplerAddressMode::Wrap, SamplerFilter::Anisotropic, SamplerFilter::Linear,
            SamplerFilter::Anisotropic);
    }
    if (lmap)
        C.r_Sampler("s_hemi", C.L_textures[2], false, nvrhi::SamplerAddressMode::Clamp, SamplerFilter::Linear, SamplerFilter::Point, SamplerFilter::Linear);
#else
