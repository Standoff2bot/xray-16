...
{
    //	C.r_Sampler	("jitter0",	JITTER(0), true, D3D_TEXTURE_ADDRESS_WRAP, D3D_TEXF_POINT, D3D_TEXF_NONE, D3D_TEXF_POINT);
    //	C.r_Sampler	("jitter1",	JITTER(1), true, D3D_TEXTURE_ADDRESS_WRAP, D3D_TEXF_POINT, D3D_TEXF_NONE, D3D_TEXF_POINT);
    //	C.r_Sampler	("jitter2",	JITTER(2), true, D3D_TEXTURE_ADDRESS_WRAP, D3D_TEXF_POINT, D3D_TEXF_NONE, D3D_TEXF_POINT);
    //	C.r_Sampler	("jitter3",	JITTER(3), true, D3D_TEXTURE_ADDRESS_WRAP, D3D_TEXF_POINT, D3D_TEXF_NONE, D3D_TEXF_POINT);
