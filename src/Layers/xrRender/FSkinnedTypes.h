...
#pragma region 1W
static VertexElement dwDecl_01W[] =
{
    {0, 0,  VF_SHORT4, 0, VS_POSITION, 0},
    {0, 8,  VF_COLOR,  0, VS_NORMAL,   0},
    {0, 12, VF_COLOR,  0, VS_TANGENT,  0},
    {0, 16, VF_COLOR,  0, VS_BINORMAL, 0},
    {0, 20, VF_SHORT2, 0, VS_TEXCOORD, 0},
    XR_VERTEX_ELEMENT_END
};

static VertexElement dwDecl_01W_HQ[] =
{
    {0, 0,  VF_FLOAT4, 0, VS_POSITION, 0},
    {0, 16, VF_COLOR,  0, VS_NORMAL,   0},
    {0, 20, VF_COLOR,  0, VS_TANGENT,  0},
    {0, 24, VF_COLOR,  0, VS_BINORMAL, 0},
    {0, 28, VF_FLOAT2, 0, VS_TEXCOORD, 0},
    XR_VERTEX_ELEMENT_END
};
#pragma endregion 1W

#pragma region 2W
static VertexElement dwDecl_2W[] =
{
    {0, 0,  VF_SHORT4, 0, VS_POSITION, 0},
    {0, 8,  VF_COLOR,  0, VS_NORMAL,   0},
    {0, 12, VF_COLOR,  0, VS_TANGENT,  0},
    {0, 16, VF_COLOR,  0, VS_BINORMAL, 0},
    {0, 20, VF_SHORT4, 0, VS_TEXCOORD, 0},
    XR_VERTEX_ELEMENT_END
};

static VertexElement dwDecl_2W_HQ[] =
{
    {0, 0,  VF_FLOAT4, 0, VS_POSITION, 0},
    {0, 16, VF_COLOR,  0, VS_NORMAL,   0},
    {0, 20, VF_COLOR,  0, VS_TANGENT,  0},
    {0, 24, VF_COLOR,  0, VS_BINORMAL, 0},
    {0, 28, VF_FLOAT4, 0, VS_TEXCOORD, 0},
    XR_VERTEX_ELEMENT_END
};
#pragma endregion 2W

#pragma region 3W
static VertexElement dwDecl_3W[] =
{
    {0, 0,  VF_SHORT4, 0, VS_POSITION, 0},
    {0, 8,  VF_COLOR,  0, VS_NORMAL,   0},
    {0, 12, VF_COLOR,  0, VS_TANGENT,  0},
...
static VertexElement dwDecl_3W_HQ[] =
{
    {0, 0,  VF_FLOAT4, 0, VS_POSITION, 0},
    {0, 16, VF_COLOR,  0, VS_NORMAL,   0},
    {0, 20, VF_COLOR,  0, VS_TANGENT,  0},
...
#pragma region 4W
static VertexElement dwDecl_4W[] =
{
    {0, 0,  VF_SHORT4, 0, VS_POSITION,     0},
    {0, 8,  VF_COLOR,  0, VS_NORMAL,       0},
    {0, 12, VF_COLOR,  0, VS_TANGENT,      0},
    {0, 16, VF_COLOR,  0, VS_BINORMAL,     0},
    {0, 20, VF_SHORT2, 0, VS_TEXCOORD,     0},
    {0, 24, VF_COLOR,  0, VS_BLENDINDICES, 0},
    XR_VERTEX_ELEMENT_END
};

static VertexElement dwDecl_4W_HQ[] =
{
    {0, 0,  VF_FLOAT4, 0, VS_POSITION,     0},
    {0, 16, VF_COLOR,  0, VS_NORMAL,       0},
    {0, 20, VF_COLOR,  0, VS_TANGENT,      0},
    {0, 24, VF_COLOR,  0, VS_BINORMAL,     0},
    {0, 28, VF_FLOAT2, 0, VS_TEXCOORD,     0},
    {0, 36, VF_COLOR,  0, VS_BLENDINDICES, 0},
    XR_VERTEX_ELEMENT_END
};
#pragma endregion 4W
