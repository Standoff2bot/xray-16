...
static VertexElement dwDecl_4W[] = // 28bytes
{
    ...
    {0, 24, D3DDECLTYPE_D3DCOLOR, D3DDECLMETHOD_DEFAULT, D3DDECLUSAGE_BLENDINDICES, 0}, // : indices : 1 :  0..255
    D3DDECL_END()
};
...
static VertexElement dwDecl_4W_HQ[] = // 40bytes
{
    ...
    {0, 36, D3DDECLTYPE_D3DCOLOR, D3DDECLMETHOD_DEFAULT, D3DDECLUSAGE_BLENDINDICES, 0}, // : indices : 1 :  0..255
    D3DDECL_END()
};
#pragma endregion 4W
