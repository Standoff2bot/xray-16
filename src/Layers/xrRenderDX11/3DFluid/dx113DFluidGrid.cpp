...
void dx113DFluidGrid::DrawSlices(void)
{
    ...
    RCache.Render(nvrhi::PrimitiveType::TriangleList, 0, m_iNumVerticesSlices / 3);
}
...
void dx113DFluidGrid::DrawSlicesToScreen(void)
{
    ...
    RCache.Render(nvrhi::PrimitiveType::TriangleList, 0, m_iNumVerticesRenderQuad / 3);
}
...
void dx113DFluidGrid::DrawBoundaryQuads(void)
{
    ...
    RCache.Render(nvrhi::PrimitiveType::TriangleList, 0, m_iNumVerticesBoundarySlices / 3);
}
...
void dx113DFluidGrid::DrawBoundaryLines(void)
{
    ...
    RCache.Render(nvrhi::PrimitiveType::TriangleList, 0, m_iNumVerticesBoundaryLines / 3);
}
} // namespace xray::render::fg
