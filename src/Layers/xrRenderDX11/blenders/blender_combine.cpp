...
void CBlender_combine::Compile(CBlender_Compile& C)
{
    ...
    {
    case 0: // combine
        C.r_Pass("combine_1", "combine_1", FALSE, FALSE, FALSE, TRUE, nvrhi::BlendFactor::InvSrcAlpha,
            nvrhi::BlendFactor::SrcAlpha); //. MRT-blend?
    ...
    {
    case 0: // combine
        C.r_Pass("combine_1", "combine_1_nomsaa", FALSE, FALSE, FALSE, TRUE, nvrhi::BlendFactor::InvSrcAlpha,
                 nvrhi::BlendFactor::SrcAlpha); //. MRT-blend?
        C.r_Stencil(TRUE, nvrhi::ComparisonFunc::LessOrEqual, 0xff, 0x00); // stencil should be >= 1
        C.r_StencilRef(0x01);
        C.r_Sampler_rtf("s_position", r2_RT_P);
        C.r_Sampler_rtf("s_normal", r2_RT_N);
        C.r_Sampler_rtf("s_diffuse", r2_RT_albedo);
...
void CBlender_combine_msaa::Compile(CBlender_Compile& C)
{
    ...
    {
    case 0: // combine
        C.r_Pass("combine_1", "combine_1_msaa", FALSE, FALSE, FALSE, TRUE, nvrhi::BlendFactor::InvSrcAlpha,
                 nvrhi::BlendFactor::SrcAlpha); //. MRT-blend?
        C.r_Stencil(TRUE, nvrhi::ComparisonFunc::LessOrEqual, 0xff, 0x00); // stencil should be >= 1
        C.r_StencilRef(0x01);
        C.r_Sampler_rtf("s_position", r2_RT_P);
