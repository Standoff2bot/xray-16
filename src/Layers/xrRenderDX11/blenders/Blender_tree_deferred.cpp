...
void CBlender_Tree::Compile(CBlender_Compile& C)
{
    ...
    case SE_R2_SHADOW: // smap-spot
        ...
        if (oBlend.value)
            C.r_Pass(tvs_s, "shadow_direct_base_aref", FALSE, TRUE, TRUE, TRUE, nvrhi::BlendFactor::Zero, nvrhi::BlendFactor::One, TRUE, 200);
        else
...
void CBlender_Tree::Compile(CBlender_Compile& C)
{
    ...
    bool bUseATOC = (oBlend.value && (RImplementation.o.msaa_alphatest==FrameGraphRenderer::MSAA_ATEST_DX10_0_ATOC));
