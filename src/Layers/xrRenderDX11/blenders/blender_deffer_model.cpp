...
void CBlender_deffer_model::Compile(CBlender_Compile& C)
{
    ...
    if (bForward)
    {
        ...
        case 1: //
            ...
            C.r_Pass(
                vsname, psname, TRUE, TRUE, FALSE, TRUE, nvrhi::BlendFactor::SrcAlpha, nvrhi::BlendFactor::InvSrcAlpha, TRUE, oAREF.value);
            ...
            if (bAref)
            {
                if (RImplementation.o.HW_smap)
                    C.r_Pass("shadow_direct_model_aref", "shadow_direct_base_aref", FALSE, TRUE, TRUE, FALSE,
                        nvrhi::BlendFactor::Zero, nvrhi::BlendFactor::One, TRUE, 220);
                else
    ...
    if (bForward)
    {
        ...
        case 1: //
            vsname = psname = "model_def_lq";
            C.r_Pass(vsname, psname, TRUE,TRUE,FALSE,TRUE, nvrhi::BlendFactor::SrcAlpha, nvrhi::BlendFactor::InvSrcAlpha, TRUE, oAREF.value);
            C.r_Sampler("s_base", C.L_textures[0]);
            C.r_End();
            break;
        default:
    ...
    else
    {
        ...
        case SE_R2_SHADOW: // smap
        {
            if (bAref)
            {
                //if (RImplementation.o.HW_smap)	C.r_Pass	("shadow_direct_model_aref","shadow_direct_base_aref",	FALSE,TRUE,TRUE,FALSE,nvrhi::BlendFactor::Zero,nvrhi::BlendFactor::One,TRUE,220);
                //else							C.r_Pass	("shadow_direct_model_aref","shadow_direct_base_aref",	FALSE);
                C.r_Pass("shadow_direct_model_aref", "shadow_direct_base_aref", FALSE,TRUE,TRUE,FALSE, nvrhi::BlendFactor::Zero,
    ...
    else
    {
        ...
        case SE_R2_SHADOW: // smap
            if (bAref)
            {
                ...
                // FALSE,TRUE,TRUE,FALSE,nvrhi::BlendFactor::Zero,nvrhi::BlendFactor::One,TRUE,220);
